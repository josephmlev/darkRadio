...
ADDRESS = 'TCPIP0::169.254.203.124::INSTR'
startFreq = 20 * 10**6 #Hz
stopFreq = 320 * 10**6 #Hz
nPoints = 10000 
...
if 1:
    ...
    print('got it')
    print()
    np.save('13.00VoltsAtBattery_SwitchOn_TGn40dBm_40dBattExternal_20dBInternal_RFpreOff', normSpecArr)
    np.save('freqArr', freqArr)
    
    plt.plot(freqArr, normSpecArr)
    '''
    input('press enter')
    INST.write(':INIT:CONT OFF')
    print('scanning...')
