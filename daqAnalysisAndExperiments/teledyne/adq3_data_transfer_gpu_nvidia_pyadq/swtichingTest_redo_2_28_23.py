    ...
    def avgFft(self):
        ...
        while not data_transfer_done:
            ...
            if self.result == pyadq.ADQ_EAGAIN:
                ...
                if print_time > 5 and s.VERBOSE_MODE:
        ...
        self.avgSpec_fftsq_Ch0    = np.asarray(avgSpec.fftSum.cpu()[:,0]/avgSpec.numFft[0])
        self.avgSpec_fftsq_Ch1    = np.asarray(avgSpec.fftSum.cpu()[:,1]/avgSpec.numFft[1])
        ...
        self.avgSpec_W_Ch0      = 2 * self.avgSpec_fftsq_Ch0 * (adcCode2V**2) /(50*s.CH0_RECORD_LEN**2)
        self.avgSpec_W_Ch1      = 2 * self.avgSpec_fftsq_Ch1 * (adcCode2V**2) /(50*s.CH1_RECORD_LEN**2)
        ...
        if s.VERBOSE_MODE:
            ...
            hc.cudaMemcpy(
                ...
                self.gpu_buffers.buffers[s.chToTest][1].data.ptr,                #source
