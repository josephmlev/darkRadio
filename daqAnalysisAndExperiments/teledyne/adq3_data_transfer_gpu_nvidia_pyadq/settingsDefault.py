...
PERIODIC_EVENT_SOURCE_PERIOD = int(2**11)
...
CH0_RECORD_LEN = int(2**11)
CH1_RECORD_LEN = CH0_RECORD_LEN


NOF_RECORDS_PER_BUFFER = 100


NOF_GPU_BUFFERS = 4 #per channel
...
CH0_SAMPLE_SKIP_FACTOR = 2
CH1_SAMPLE_SKIP_FACTOR = CH0_SAMPLE_SKIP_FACTOR
...
CH0_TEST_PATTERN_SOURCE = pyadq.ADQ_TEST_PATTERN_SOURCE_COUNT_UP
CH1_TEST_PATTERN_SOURCE = pyadq.ADQ_TEST_PATTERN_SOURCE_COUNT_UP

BYTES_PER_SAMPLES = 2
PRINT_LAST_BUFFERS = 1
