...
if __name__ == "__main__":
    ...
    transfer_thread = threading.Thread(target = transferData, args=(sem,))
    check_buffer_thread = threading.Thread(target=checkBuffer, args = (sem,))
