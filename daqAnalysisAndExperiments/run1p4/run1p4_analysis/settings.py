...
NOF_BUFFERS_TO_RECEIVE          = 8600 #for each call of avgFFT()
NOF_ACQUISITIONS_TO_TAKE        = 464 #number of times to call avgFFT()
...
SAVE_DIRECTORY                  = '/drBiggerBoy/run1p4/' #directory to save data. Note this needs to be created ahead of time
