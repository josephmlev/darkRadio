...
##########################################################
# Run 1p4 injection test main daq settings
##########################################################
import pyadq
...
NOF_BUFFERS_TO_RECEIVE          = 1430 #for each call of avgFFT()
NOF_ACQUISITIONS_TO_TAKE        = 48 #number of times to call avgFFT()
...
PATH_TO_SAVE_SINGLE_SPEC        ='/drBigBoy/darkRadio/daqAnalysisAndExperiments/run1p4/runTesting_3_30_23/32dB_attTest_long_vetoConnected' #Where to save above

NUM_SPEC_PER_FILE               = 16 #How many spectra to put in a file. Keep files around 1GB. 16 is good
SAVE_DIRECTORY                  = '/drBiggerBoy/run1p4_injectionTest2/' #directory to save data. Note this needs to be created ahead of time
