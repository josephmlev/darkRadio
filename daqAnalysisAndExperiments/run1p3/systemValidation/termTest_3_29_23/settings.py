...
NOF_ACQUISITIONS_TO_TAKE        = 120 #number of times to call avgFFT()
...
SAVE_DIRECTORY                  = '/drBiggerBoy/termTest_3_29_23/' #directory to save data. Note this needs to be created ahead of time
