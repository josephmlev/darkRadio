...
NOF_BUFFERS_TO_RECEIVE          = 10000 #for each call of avgFFT()
NOF_ACQUISITIONS_TO_TAKE        = 1100 #number of times to call avgFFT()

NOF_GPU_BUFFERS                 = 2 #per channel. Crashes if not 2.

INIT_SLEEP_TIME			= 10 #Time in seconds to sleep before starting anything
...
SAVE_DIRECTORY                  = '/drBiggerBoy/runTest_3_30_23/' #directory to save data. Note this needs to be created ahead of time
...
SWITCH_SLEEP_TIME		= .05 #Time in seconds to sleep after switching
...
CH_TO_TEST                      = 0 # Sets which channel to plot and save. assumes TEST_MODE = 1
