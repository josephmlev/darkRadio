...
##########################################################
# Run 1p3 injection daq settings
##########################################################
import pyadq
...
SAVE_DIRECTORY                  = '/drBiggerBoy/run1p3/injection_data/' #directory to save data. Note this needs to be created ahead of time
...
ANT_POS_IDX                     = 4 # Written to H5 and database, does not affect behavor.
